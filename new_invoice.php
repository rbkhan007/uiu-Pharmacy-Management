            ...
            <div class="row">
                ...
                <div class="row col col-md-12">
                    ...
                    <div class="col col-md-3 form-group">
                        ...
                        <input id="customers_address" type="text" class="form-control" name="customers_address" placeholder="Address" required>
                    </div>
                    <div class="col col-md-2 form-group">
                        <label class="font-weight-bold" for="invoice_number">Invoice Number :</label>
                        <input id="invoice_number" type="text" class="form-control" name="invoice_number" placeholder="Invoice Number" required>
                    </div>
                    <div class="col col-md-2 form-group">
                    ...
                    <div class="col col-md-2 form-group">
                        ...
                        <input type="date" class="datepicker form-control hasDatepicker" id="invoice_date" value='<?php echo date('Y-m-d'); ?>' onblur="checkDate(this.value, 'date_error');" required>
                ...
                <div class="row col col-md-12">
                    ...
                    <div class="col col-md-2 form-group">
                        ...
                        <input id="customers_contact_number" type="number" class="form-control" name="customers_contact_number" placeholder="Contact Number" required>
                    </div>
                </div>
                ...
                <div class="row col col-md-12">
                    <div class="row col col-md-12 font-weight-bold">
                        ...
                        <div class="col col-md-1">M.R.P. (BDT)</div> <!-- Updated label -->
